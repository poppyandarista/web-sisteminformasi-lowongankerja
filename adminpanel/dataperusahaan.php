    ...
    <nav
      ...
      <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        <nav>
          ...
          <h6 class="mb-0 font-bold capitalize">Data Perusahaan</h6>
        </nav>
          ...
          <div
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
              <div class="p-0 overflow-x-auto">
                <table id="tabelPerusahaan" class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                  ...
                  <tbody>
                    ...
                    if (!empty($data_perusahaan)) {
                      foreach ($data_perusahaan as $row):
                        // LOGIKA FORMAT ID C0001
                        $format_id = "C" . str_pad($row['id_perusahaan'], 4, "0", STR_PAD_LEFT);
                        ?>
                        <tr>
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <div class="flex px-4 py-1">
                              <span class="text-xs font-bold leading-tight text-slate-700"><?php echo $format_id; ?></span>
                            </div>
                          </td>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <div class="flex px-2 py-1">
                              ...
                              <div class="flex flex-col justify-center">
                                <h6 class="mb-0 text-sm leading-normal"><?php echo $row['nama_perusahaan']; ?></h6>
                                <p class="mb-0 text-xs leading-tight text-slate-400"><?php echo $row['email_perusahaan']; ?>
                                </p>
                              </div>
                            </div>
                          </td>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <p class="mb-0 text-xs font-semibold leading-tight"><?php echo $row['kota_perusahaan']; ?></p>
                            <p class="mb-0 text-xs leading-tight text-slate-400"><?php echo $row['provinsi_perusahaan']; ?>
                            </p>
                          </td>
                          ...
                          <td
                            ...
                            <span
                              class="text-xs font-semibold leading-tight text-slate-400"><?php echo $row['nohp_perusahaan']; ?></span>
                          </td>
                          ...
                          <td
                            ...
                            <div class="flex justify-center items-center">
                              ...
                              <a href="edit_perusahaan.php?id=<?php echo $row['id_perusahaan']; ?>"
                                class="inline-block px-4 py-2 mr-2 mb-0 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer shadow-soft-md bg-gradient-to-tl from-yellow-400 to-yellow-200 leading-pro text-xxs ease-soft-in hover:scale-102 active:opacity-85">
                                EDIT
                              </a>

                              <a href="hapus_perusahaan.php?id=<?php echo $row['id_perusahaan']; ?>"
                                onclick="return confirm('Yakin ingin menghapus?')"
                                class="inline-block px-4 py-2 mb-0 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer shadow-soft-md bg-gradient-to-tl from-red-600 to-rose-400 leading-pro text-xxs ease-soft-in hover:scale-102 active:opacity-85">
                                HAPUS
                              </a>
