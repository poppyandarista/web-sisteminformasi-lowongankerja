    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.php" class="lg:hidden">
                <img class="dark:hidden w-15 h-8 object-contain" src="src/images/logo/logo2.png" alt="Logo" />
                <img class="hidden dark:block w-15 h-8 object-contain" src="src/images/logo/logo2.png" alt="Logo" />
            </a>
        </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="src/images/user/<?php echo $_SESSION['foto_admin'] ?? 'default.jpg'; ?>"
                            alt="User" /><img
                            src="src/images/user/<?php echo !empty($_SESSION['foto_admin']) ? $_SESSION['foto_admin'] : 'user-01.png'; ?>"
                            alt="User" /> </span>

                    <span class="text-theme-sm mr-1 block font-medium"> <?php echo $_SESSION['nama_admin']; ?> </span>
