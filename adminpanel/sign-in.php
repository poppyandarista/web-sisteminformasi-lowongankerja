...
if (isset($_POST['login'])) {
  ...
  // Panggil fungsi login_admin yang baru kita buat di koneksi.php
  $data_user = $db->login_admin($username, $password);

  if ($data_user) {
    // Tambahkan baris ini agar ID admin tersimpan di session
            ...
            <div class="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
              <div
                ...
                <div class="flex-auto p-6">
                  <?php if ($error != ""): ?>
                    <div class="p-3 mb-4 text-white bg-red-500 rounded-lg text-sm text-center">
                      <?php echo $error; ?>
                    </div>
                  <?php endif; ?>
