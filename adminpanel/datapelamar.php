        ...
        <div class="flex-none w-full max-w-full px-3">
          <div
            ...
            <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
              <h6>Tabel Data Pelamar</h6>
            </div>
            <div class="flex-auto px-0 pt-0 pb-2">
              <div class="p-0 overflow-x-auto">
                <table id="tabelPelamar" class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                  ...
                  <tbody>
                    ...
                    if (!empty($data_pelamar)) {
                      foreach ($data_pelamar as $row):
                        ...
                        $format_id = "U" . str_pad($row['id_user'], 4, "0", STR_PAD_LEFT);
                        ?>
                        <tr>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <div class="flex px-2 py-1">
                              <div>
                                <img src="build/assets/img/logos/"
                              ...
                              <div class="flex flex-col justify-center">
                                ...
                                <p class="mb-0 text-xs leading-tight text-slate-400"><?php echo $row['email_user']; ?>
                                </p>
                              </div>
                            </div>
                          </td>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap text-center">
                            <div class="flex justify-center items-center gap-2">
                              ...
                              <a href="detail_user.php?id=<?php echo $row['id_user']; ?>"
