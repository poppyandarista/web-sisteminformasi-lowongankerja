...
<head>
  ...
  <title>Dashboard Admin - LinkUp</title>
  <!--     Fonts and icons     -->
                ...
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 class="mb-0 font-bold">
                      <?php echo number_format($db->jumlah_pelamar()); ?>
                      <span class="leading-normal text-sm font-weight-bolder text-lime-500">Orang</span>
                    </h5>
                  </div>
                </div>
              ...
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 class="mb-0 font-bold">
                      <?php echo number_format($db->jumlah_perusahaan()); ?>
                      <span class="leading-normal text-sm font-weight-bolder text-lime-500">Perusahaan</span>
                    </h5>
                  </div>
                </div>
                <div class="px-3 text-right basis-1/3">
              ...
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 class="mb-0 font-bold">
                      <?php echo number_format($db->jumlah_lowongan()); ?>
                      <span class="leading-normal text-sm font-weight-bolder text-lime-500">Lowongan</span>
                    </h5>
                  </div>
                </div>
                <div class="px-3 text-right basis-1/3">
              ...
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <h5 class="mb-0 font-bold">
                      <?php echo number_format($db->jumlah_lamaran()); ?>
                      <span class="leading-normal text-sm font-weight-bolder text-lime-500">Lamaran</span>
                    </h5>
                  </div>
                </div>
                <div class="px-3 text-right basis-1/3">
        ...
        <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
          <div
            ...
            <div class="flex-auto p-4">
              ...
              <h6 class="mt-6 mb-0 ml-2">Tren Lowongan Baru per Bulan</h6>
...
<!-- main script file  -->
<script src="https://cdn.jsdelivr.net/npm/soft-ui-dashboard-tailwind@1.0.5/dist/js/soft-ui-dashboard-tailwind.min.js"
  async></script>
