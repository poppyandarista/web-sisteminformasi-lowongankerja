        ...
        <div class="flex-none w-full max-w-full px-3">
          <div
            ...
            <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
              <h6>Tabel Data Lowongan</h6>
            </div>
            <div class="flex-auto px-0 pt-0 pb-2">
              <div class="p-0 overflow-x-auto">
                <table id="tabelLowongan" class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                  ...
                  <tbody>
                    ...
                    if (!empty($data_lowongan)) {
                      foreach ($data_lowongan as $row):
                        $format_id = "J" . str_pad($row['id_lowongan'], 4, "0", STR_PAD_LEFT);
                        ?>
                        <tr>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                            <div class="flex px-2 py-1">
                              <div>
                                <img src="build/assets/img/logos/<?php echo $row['logo_perusahaan']; ?>"
                                  class="inline-flex items-center justify-center mr-4 text-sm text-white h-9 w-9 rounded-xl" />
                              </div>
                              <div class="flex flex-col justify-center">
                                <h6 class="mb-0 text-sm leading-normal"><?php echo $row['judul_lowongan']; ?></h6>
                                <p class="mb-0 text-xs text-slate-400"><?php echo $row['nama_perusahaan']; ?></p>
                              </div>
                            </div>
                          </td>

                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                            <p class="mb-0 text-xs font-semibold"><?php echo $row['kategori_lowongan']; ?></p>
                            <p class="mb-0 text-xs text-slate-400"><?php echo $row['waktukerja']; ?></p>
                          </td>

                          <td class="p-2 align-middle bg-transparent border-b">
                            <p class="mb-0 text-xs font-semibold text-success">Rp
                              <?php echo number_format($row['gaji_lowongan'], 0, ',', '.'); ?>
                            </p>
                            <p class="mb-0 text-xs text-slate-500">
                              <i class="fas fa-map-marker-alt"></i> <?php echo $row['kota_lowongan']; ?>,
                              <?php echo $row['provinsi_lowongan']; ?>
                            </p>
                          ...
                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                            <div class="text-center">
                              <p class="mb-0 text-xs font-semibold">Post:
                                <?php echo date('d/m/Y', strtotime($row['tanggal_posting'])); ?>
                              </p>
                              <p class="mb-0 text-xs text-danger">Tutup:
                          ...
                          <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap">
                            <?php if ($row['status'] == 'Aktif'): ?>
                              <span
                                class="bg-gradient-to-tl from-green-600 to-lime-400 px-2.5 text-xs rounded-1.8 py-1.4 inline-block text-white font-bold">AKTIF</span>
                            <?php else: ?>
                              <span
                                class="bg-gradient-to-tl from-slate-600 to-slate-300 px-2.5 text-xs rounded-1.8 py-1.4 inline-block text-white font-bold">NONAKTIF</span>
                            <?php endif; ?>
                          </td>

                          <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap text-center">
                            <div class="flex justify-center items-center gap-2">
                              <a href="edit_lowongan.php?id=<?php echo $row['id_lowongan']; ?>"
                                class="bg-gradient-to-tl from-yellow-400 to-yellow-200 px-3 py-1 mr-2 rounded-lg text-white text-xxs font-bold uppercase">
                                Edit
                              </a>

                              <a href="hapus_lowongan.php?id=<?php echo $row['id_lowongan']; ?>"
                                onclick="return confirm('Yakin ingin menghapus lowongan ini?')"
                                class="bg-gradient-to-tl from-red-600 to-rose-400 px-3 py-1 mr-2 rounded-lg text-white text-xxs font-bold uppercase">
                                Hapus
                              </a>

                              <a href="detail_lowongan.php?id=<?php echo $row['id_lowongan']; ?>"
                                class="bg-gradient-to-tl from-blue-600 to-cyan-400 px-3 py-1 rounded-lg text-white text-xxs font-bold uppercase">
                                Detail
                              </a>
                            </div>
                          </td>
